# Load data from SQLite offline database into SfCalendar Xamarin.Android
This example demonstrates how to load data from SQLite offline database into SfCalendar Xamarin.Android
